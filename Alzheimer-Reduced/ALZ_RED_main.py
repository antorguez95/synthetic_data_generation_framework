...
DATASET_PATH = r"C:\Users\aralmeida\OneDrive - Universidad de Las Palmas de Gran Canaria\Doctorado\Bases de datos\Alzheimer\Balea-Reducida"
...
data, X, Y, feat_names, y_tag = prepare_ALZ_RED(dataset_path = DATASET_PATH, filename = filename)
...
if BALANCING_CHECKED  == False : 
    ...
    balancing_eval('ALZ-BALEA', X_train, y_train, train_data,
                 feat_names, y_tag, [None, "SMOTE", "SMOTENC", None, "SVMSMOTE", "BorderlineSMOTE"], 
...
controls = train_data.loc[(train_data["TNeurocog"]==0)] 
cases = train_data.loc[(train_data["TNeurocog"]==1)]
...
plt.savefig('ALZ-BALEA_metrics_vs_synthetic_data_samples', dpi=600)
...
plt.savefig('ALZ-BALEA_f1_vs_data_samples', dpi = 600)
...
ax[0].legend(models, bbox_to_anchor=(0.07,1.02,1,0.2), loc="lower left",
                mode="None", borderaxespad=0, ncol=4, prop={'size': 6})
# Save figure
plt.savefig('ALZ-BALEA_sdg_metrics_vs_f1_score', dpi=600)